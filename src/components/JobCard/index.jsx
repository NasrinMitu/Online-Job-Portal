...
function JobCard() {
    ...
    const diffInDays = date1.diff('2024-03-23', 'day');
    return(
        <div className="mx-40 mb-4"> 
            <div className="flex justify-between items-center px-6 py-4 bg-zinc-200 rounded-md border border-black shadow-black shadow-lg hover:border-blue-500">
